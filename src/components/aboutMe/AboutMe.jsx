...
const AboutMe = () => {
  return (
    <div>
      ...
      <p>Hello! My name is Kevin Ma, and I am passionate and driven about learning and creating all things related to tech, 
        with a current focus on front-end web development and backend unit integration testing.
      </p>
      <p>
      ...
      <p>It was the safe path to a stable life my parents wanted for me, but I felt like I was a zombie; mindlessly wandering through life on a predetermined track, just half-living. Literally. Half the year - October through April - I worked 80-100 hour weeks and the other half I did barely 20 hours.</p>
